...
createUSmap <- function(colName,colorPlot, nameScale, titlePlot){
  returnPlot <-  plot_usmap(data =greenCard, values=colName,regions = "states") + 
    ...
    labs(title = titlePlot, title.postion = "top")+
...
barPlotData %>% ggplot(mapping = aes(fct_reorder(VarName,
  ...
  scale_fill_manual(values=c("gasPercent"="brown","nuclearPercent"="green","coalPercent"="black","windPercent"="lightblue",
                             "hydroPercent"="darkblue","solarPercent"="yellow","biomassPercent"="darkgreen",
                             "petroleumPercent"="grey","geothermalPercent"="red"), 
                       name="Energy Source",
                       labels=c("Gas","Nuclear", "Coal", "Wind", "Hydro", "Solar", "Biomass","Petroleum", "Geothermal"))+
  #legend(x= aes(fct_reorder(VarName, VarValues, .desc = TRUE), VarValues),fill = c("brown","green","black","lightblue","darkblue","yellow","darkgreen","grey","red"), legend = c("Gas","Nuclear", "Coal", "Wind", "Hydro", "Solar", "Biomass","Petroleum", "Geothermal"))
